        ...
        <div class="container">
            <div class="row py-1 d-flex justify-content-md-around">
                ...
                <div class="d-none d-lg-flex col-lg-4 justify-content-center align-items-center p-2 text-white">
                    ...
                    <p class="my-auto ml-3">Rua: José Luiz Regal, Nº 96, Altos do Itavuvu<br/>Sorocaba/SP</p>
                </div>
                ...
                <div class="d-flex col-12 col-md-6 col-lg-4 justify-content-center align-items-center p-2 text-white mx-auto">
                    ...
                    <p class="my-auto ml-3">contatoinfo@altituderealimobiliaria.projetosdeploy.com.br<br/>+55 (15) 9-8817-1471</p>
                </div>
...
<div class="main_copyright py-3 bg-front text-white text-center">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <p class="mb-0">Altitude Real Imobiliaria | CRECI 1234 | Rua: José Luiz Regal, Nº 96, Altos do Itavuvu Sorocaba/SP</p>
                <p class="mb-0">Todos os Direitos Reservados - ProjetosDeploy ®</p>
            </div>
        </div>
    </div>
</div>
