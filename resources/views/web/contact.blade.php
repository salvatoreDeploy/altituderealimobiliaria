        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-12 col-md-4">
                    ...
                    <p class="pt-2"><a href="mailto:contatoinfo@altituderealimobiliaria.projetosdeploy.com.br" class="text-front">contatoinfo@altituderealimobiliaria.projetosdeploy.com.br</a></p>
                </div>

                <div class="col-12 col-md-4">
                    <h2 class="icon-phone">Por Telefone</h2>
                    <p>Estamos disponíveis nos números abaixo no horário comercial.</p>
                    <p class="pt-2 text-front">+55 (15) 9-8817-1471</p>
                </div>
